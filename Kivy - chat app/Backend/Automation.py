...
def PlayYoutube(command):
    if "next video" in command or "next" in command:
        pyautogui.hotkey('shift', 'n')

    elif "video" in command or "song" in command or command == "play":
        keyboard.press_and_release("space")

    elif "first video" in command or "1st video" in command:
        pyautogui.moveTo(560, 405)
        pyautogui.click()

    elif "second video" in command or "2nd video" in command:
        pyautogui.moveTo(1147, 394)
        pyautogui.click()

    elif "third video" in command or "3rd video" in command:
        pyautogui.moveTo(1715, 374)
        pyautogui.click()

    elif "fourth video" in command or "4th video" in command:
        pyautogui.moveTo(564, 836)
        pyautogui.click()

    elif "fifth video" in command or "5th video" in command:
        pyautogui.moveTo(1142, 818)
        pyautogui.click()

    elif "sixth video" in command or "6th video" in command:
...
def System(command):
    ...
    #     elif "video speed kar" in command or "speed video" in command or "speed the video" in command:
    #         pyautogui.press(">")

    #     elif "video slow kar" in command or "slow video" in command or "slow the video" in command:
    #         pyautogui.press("<")
