        ...
        ScreenManager:
            ...
            MDScreen:
                ...
                MDBoxLayout:
                    ...
                    MDTopAppBar:
                        #title: ""  # Remove title to use custom layout
                        elevation: 12
                        anchor_title: "left"
                        use_overflow: True

                        # Properly Centered Box Layout
                        MDBoxLayout:
                            orientation: "horizontal"
                            adaptive_height: True
                            spacing: "10dp"
                            pos_hint: {"center_x": 0.05, "center_y": 0.5}  # Moves logo & text left but centered in Y

                            FitImage:
                                source: "topbarlogo.png"
                                size_hint: None, None
                                size: "40dp", "40dp"  # Adjust for visibility
                                radius: [20, 20, 20, 20]  # Makes it fully circular
                            ...
                            MDLabel:
                                ...
                                font_size: "20sp"
                                size_hint_x: None
                                width: self.texture_size[0] + 10  # Adjusts width dynamically
                                pos_hint: {"center_y": 0.5}  # Perfectly center aligns text
                    ...
                    if isinstance(child, MDCard):  # 🔄 Check if message is inside an extra MDCard
                        for subchild in child.children:
                            if isinstance(subchild, MDLabel):
                                subchild.text = f"{Username}: {new_message}"
                                return
